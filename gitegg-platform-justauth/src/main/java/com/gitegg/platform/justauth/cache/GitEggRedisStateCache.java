...
package com.gitegg.platform.justauth.cache;
...
public class GitEggRedisStateCache implements AuthStateCache {
    ...
    public GitEggRedisStateCache(RedisTemplate<String, String> redisTemplate, CacheProperties cacheProperties, Boolean enable) {
    ...
    public void cache(String key, String value, long timeout) {
        if (enable)
        {
            key = key + (key.endsWith(StrUtil.COLON) ? "" : StrUtil.COLON) + GitEggAuthUtils.getTenantId();
        }
